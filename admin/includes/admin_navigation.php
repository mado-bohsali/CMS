...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li><a href="">Users Online: <span class="onlineUsers"> </span></a></li>
                <script>
                    //Instantaneous get who is online
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <?php if(is_admin($_SESSION['username'])): ?>
                        <li>
                            <a href="dashboard.php"><i class="fa fa-fw fa-dashboard"></i> General dashboard</a>
                        </li>
                    ...
                    <li>
                        <a href="./categories.php"><i class="fa fa-fw fa-desktop"></i> Bootstrap Elements</a>
                    </li>
                    <li>
